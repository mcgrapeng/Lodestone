...
import { navigationLinkVariants } from '../navigation/navigation-link-variants.js';
...
function DropdownMenu({ size = "md", children, ...rest }) {
  const reducedMotion = useReducedMotion();
  const ctx = React.useMemo(() => ({ size, reducedMotion }), [size, reducedMotion]);
  return /* @__PURE__ */ jsx(DropdownMenuContext, { value: ctx, children: /* @__PURE__ */ jsx(Menu.Root, { ...rest, children }) });
}
function DropdownMenuTrigger({ className, ...props }) {
  return /* @__PURE__ */ jsx(Menu.Trigger, { "data-slot": "dropdown-menu-trigger", className: cn(className), ...props });
}
const POPUP_SIZE = {
...
function popupClassName(size, className) {
  return cn(
...
function DropdownMenuContent({ className, children, ...props }) {
  ...
  return /* @__PURE__ */ jsx(Menu.Portal, { ...portal, children: /* @__PURE__ */ jsx(
    Menu.Positioner,
    {
      align: "start",
      sideOffset: 6,
      ...
      children: /* @__PURE__ */ jsx(Menu.Popup, { "data-slot": "dropdown-menu-content", className: popupClassName(size, className), ...popup, children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-0.5 overflow-x-hidden overflow-y-auto p-2", children }) })
    }
  ) });
}
...
function DropdownMenuLinkItem({ className, ...props }) {
  const { size } = useDropdownMenuContext();
  return /* @__PURE__ */ jsx(
    Menu.LinkItem,
    {
...
function DropdownMenuGroupLabel({ className, ...props }) {
  const { size } = useDropdownMenuContext();
  return /* @__PURE__ */ jsx(
    Menu.GroupLabel,
    {
...
function DropdownMenuRadioItem({ className, children, ...props }) {
  ...
  return /* @__PURE__ */ jsxs(
    Menu.RadioItem,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { className: cn("flex items-center", ITEM_TEXT[size]), children }),
        /* @__PURE__ */ jsx(
          Menu.RadioItemIndicator,
          {
            ...
            children: /* @__PURE__ */ jsx(CheckIcon, { "data-icon": "end", className: "me-0.5 size-[1.125em]" })
          }
        )
      ]
    }
...
function DropdownMenuSubTrigger({ className, children, ...props }) {
  const { size } = useDropdownMenuContext();
  return /* @__PURE__ */ jsx(Menu.SubmenuTrigger, { className: "group/submenu-trigger outline-hidden", ...props, children: /* @__PURE__ */ jsxs(
    "span",
    {
      "data-slot": "dropdown-menu-sub-trigger",
      className: cn(navigationLinkVariants({ variant: "pill", size }), ITEM_BASE, "justify-between", className),
      children: [
        /* @__PURE__ */ jsx("span", { className: cn("flex flex-1 items-center", ITEM_TEXT[size]), children }),
        /* @__PURE__ */ jsx(ChevronEndIcon, { "data-icon": "end", className: cn(ICON_SIZE[size], "shrink-0 rtl:rotate-180") })
      ]
    }
  ) });
}
function DropdownMenuSubContent({ className, children, ...props }) {
  ...
  return /* @__PURE__ */ jsx(Menu.Portal, { ...portal, children: /* @__PURE__ */ jsx(
    Menu.Positioner,
    {
      ...
      ...positioner,
      className: cn("isolate z-50", positioner.className),
      children: /* @__PURE__ */ jsx(Menu.Popup, { "data-slot": "dropdown-menu-sub-content", className: popupClassName(size, className), ...popup, children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-0.5 overflow-x-hidden overflow-y-auto p-2", children }) })
    }
  ) });
}
...
function ChevronEndIcon(props) {
  return /* @__PURE__ */ jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true", ...props, children: /* @__PURE__ */ jsx("path", { d: "M5.558 3.558c.244-.244.641-.244.885 0l4 4c.244.244.244.641 0 .885l-4 4c-.244.244-.641.244-.885 0s-.244-.641 0-.885L9.115 8 5.558 4.442c-.244-.244-.244-.641 0-.885z" }) });
}

export { DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuGroup, DropdownMenuGroupLabel, DropdownMenuItem, DropdownMenuLinkItem, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger };
