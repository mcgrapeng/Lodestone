...
import { LazyMotion, domAnimation, useMotionValue, animate, useTransform, m } from 'motion/react';
...
function Circular({ colors, reduced }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("circle", { cx: "20", cy: "20", r: "16", className: colors.track }),
        reduced ? /* @__PURE__ */ jsx("circle", { cx: "20", cy: "20", r: "16", pathLength: 1, strokeDasharray: "0.25 0.75" }) : /* @__PURE__ */ jsx(
          m.circle,
          {
            cx: "20",
            cy: "20",
...
function Dots({ colors, reduced }) {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      children: Array.from({ length: DOT_COUNT }, (_, i) => {
        ...
        return reduced ? /* @__PURE__ */ jsx("rect", { ...sharedProps, opacity: 0.25 }, i) : /* @__PURE__ */ jsx(
          m.rect,
          {
            ...sharedProps,
            initial: { opacity: 0 },
...
function buildSparklePath(nums) {
...
function Sparkle({ colors, reduced }) {
  ...
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      "aria-hidden": "true",
      className: cn("size-[1em]", colors.indicator),
      children: reduced ? /* @__PURE__ */ jsx("path", { d: SPARKLE_MORPH_PATH }) : /* @__PURE__ */ jsx(m.path, { d, style: { transformOrigin: "12px 12px", rotate } })
    }
  );
}
