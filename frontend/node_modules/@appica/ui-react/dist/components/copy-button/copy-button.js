...
function CopyButton({
  ...
  const resetRef = React.useRef(void 0);
  ...
  return /* @__PURE__ */ jsxs(
    Button,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxs("span", { "data-icon": children != null ? "start" : void 0, className: "grid place-items-center *:[grid-area:1/1]", children: [
          /* @__PURE__ */ jsx(
            "svg",
            {
              ...ICON_SVG_PROPS,
              ...
              children: /* @__PURE__ */ jsx("path", { d: "M4.012 16.737c-.307-.175-.562-.427-.739-.732S3.001 15.353 3 15V5c0-1.1.9-2 2-2h10c.75 0 1.158.385 1.5 1M7 9.667c0-.707.281-1.386.781-1.886S8.96 7 9.667 7h8.666c.35 0 .697.069 1.021.203s.618.33.865.578.444.542.578.865A2.67 2.67 0 0 1 21 9.667v8.666a2.67 2.67 0 0 1-.781 1.886 2.67 2.67 0 0 1-1.886.781H9.667a2.67 2.67 0 0 1-1.021-.203c-.324-.134-.618-.331-.865-.578s-.444-.542-.578-.865S7 18.683 7 18.333V9.667z" })
            }
          ),
          /* @__PURE__ */ jsx("svg", { ...ICON_SVG_PROPS, children: /* @__PURE__ */ jsx(
            "path",
            {
              d: CHECK_PATH,
              pathLength: 1,
        ...
        /* @__PURE__ */ jsx("span", { role: "status", className: "sr-only", children: copied ? copiedLabel : "" })
      ]
    }
  );
}
