...
function Badge({ className, variant, size, render, ...props }) {
  const renderedProps = React.isValidElement(render) ? render.props : void 0;
  const interactive = React.isValidElement(render) && (render.type === "a" || render.type === "button") || props.onClick != null || renderedProps?.href != null || renderedProps?.onClick != null || renderedProps?.tabIndex != null;
  return useRender({
    defaultTagName: "span",
    render,
    state: { variant, size },
