  ...
  "relative isolate flex items-center data-[orientation=horizontal]:justify-center data-[orientation=vertical]:w-full data-[orientation=horizontal]:text-center data-[orientation=vertical]:text-start data-[orientation=horizontal]:whitespace-nowrap transform-gpu transition-transform duration-250 ease-[cubic-bezier(0.175,0.885,0.32,1.5)] motion-reduce:transition-none group-active/trigger:scale-[0.97] group-active/trigger:duration-100 group-active/trigger:ease-in-out group-active/trigger:translate-y-px",
  {
    ...
    compoundVariants: [
      ...
      { variant: "pill", size: "icon-lg", class: "rounded-lg" },
      {
        variant: "line",
        size: "sm",
        class: "data-[orientation=vertical]:ps-3 data-[orientation=vertical]:has-data-[icon=end]:pe-2 data-[orientation=vertical]:has-data-[icon=start]:ps-2"
      },
      {
        variant: "line",
        size: "md",
        class: "data-[orientation=vertical]:ps-4 data-[orientation=vertical]:has-data-[icon=end]:pe-3 data-[orientation=vertical]:has-data-[icon=start]:ps-3"
      },
      {
        variant: "line",
        size: "lg",
        class: "data-[orientation=vertical]:ps-5 data-[orientation=vertical]:has-data-[icon=end]:pe-4 data-[orientation=vertical]:has-data-[icon=start]:ps-4"
      }
    ],
    defaultVariants: { variant: "pill", size: "md" }
  }
);
const tabsContentClasses = "outline-none transition-[opacity,filter] duration-400 ease-out motion-reduce:transition-none data-[starting-style]:opacity-0 data-[ending-style]:hidden";
function Tabs({ variant = "pill", size = "md", orientation = "horizontal", className, ...rest }) {
  const ctx = React.useMemo(() => ({ variant, size, orientation }), [variant, size, orientation]);
  return /* @__PURE__ */ jsx(TabsContext, { value: ctx, children: /* @__PURE__ */ jsx(
    Tabs$1.Root,
    {
      "data-slot": "tabs",
      orientation,
...
function TabsList({ variant: variantProp, size: sizeProp, className, children, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs(Tabs$1.List, { "data-slot": "tabs-list", className: cn(tabsListVariants({ variant, size }), className), ...rest, children: [
    /* @__PURE__ */ jsx(
      Tabs$1.Indicator,
      {
    ...
    /* @__PURE__ */ jsx(TabsContext, { value: listCtx, children })
  ] });
}
function TabsTrigger({ variant: variantProp, size: sizeProp, className, children, ...rest }) {
  const ctx = useTabsContext();
  const variant = variantProp ?? ctx.variant;
  const size = sizeProp ?? ctx.size;
  return /* @__PURE__ */ jsx(Tabs$1.Tab, { "data-slot": "tabs-trigger", className: cn(tabsTriggerVariants({ variant, size }), className), ...rest, children: /* @__PURE__ */ jsx(
    "span",
    {
...
function TabsContent({ className, ...rest }) {
  return /* @__PURE__ */ jsx(Tabs$1.Panel, { "data-slot": "tabs-content", className: cn(tabsContentClasses, className), ...rest });
}
