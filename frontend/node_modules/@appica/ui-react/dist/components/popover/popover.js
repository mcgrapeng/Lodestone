...
function PopoverContent({ className, arrow = true, children, ...props }) {
  const { positioner, portal, popup } = splitFloatingProps(props);
  return /* @__PURE__ */ jsx(Popover$1.Portal, { ...portal, children: /* @__PURE__ */ jsx(
    Popover$1.Positioner,
    {
      ...
      children: /* @__PURE__ */ jsxs(Popover$1.Popup, { className: "group/popup outline-none", ...popup, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        arrow && /* @__PURE__ */ jsx(
          Popover$1.Arrow,
          {
            ...
            children: /* @__PURE__ */ jsx(PopoverArrowSvg, {})
          }
        )
      ] })
    }
...
function PopoverArrowSvg() {
  return /* @__PURE__ */ jsxs("svg", { width: "26", height: "18", viewBox: "0 0 26 18", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx(
      "path",
      {
...
function PopoverDescription({ className, ...props }) {
  return /* @__PURE__ */ jsx(Popover$1.Description, { "data-slot": "popover-description", className: cn("text-sm", className), ...props });
}
