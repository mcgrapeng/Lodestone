...
import { ChildNodeSubjectType } from './utils';
...
export type AccessibilityType = CreatePluginType<{
    setupPrevAndNextButtons: (prevButton: ChildNodeSubjectType, nextButton: ChildNodeSubjectType) => void;
...
declare function Accessibility(userOptions?: AccessibilityOptionsType): AccessibilityType;
